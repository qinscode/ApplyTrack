  ...
  const [qaItems, setQAItems] = useState<QAItem[]>([
    {
      ...
      answer:
        "Start with current role, highlight key achievements, mention relevant experience, and conclude with career goals.",
      category: "Behavioral",
      difficulty: "Easy",
    ...
    },
    {
      ...
      answer:
        "Choose a real weakness, but focus on steps taken to improve and overcome it.",
      category: "Behavioral",
      difficulty: "Medium",
    ...
    },
    {
      ...
      category: "Technical",
      answer:
        "Virtual DOM is a lightweight copy of the actual DOM. React uses it to improve performance by minimizing direct DOM manipulation.",
      difficulty: "Hard",
