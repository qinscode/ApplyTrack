...
import { Briefcase, MapPin, DollarSign, Calendar, ArrowLeft, ExternalLink } from 'lucide-react'
        ...
        <Card>
          <CardContent className="p-6 md:p-8">
            <div className="mb-6 grid grid-cols-1 gap-4 md:grid-cols-2">
              ...
              <a href={job.url} target="_blank" rel="noopener noreferrer" className="mb-4 w-1/2">
            ...
            <h2 className="mb-4 text-xl text-gray-600 dark:text-gray-300">{job.business_name}</h2>
            <div className="mb-6 grid grid-cols-1 gap-4 md:grid-cols-2">
            ...
            <div className="mb-6 grid grid-cols-1 gap-4 md:grid-cols-2">
              <div className="mb-6">
                <h3 className="mb-2 text-xl font-semibold text-gray-900 dark:text-white">Status</h3>
                <Badge className={`${statusColors[status]} pointer-events-none font-semibold`}>
                  {status}
                </Badge>
              </div>
