  ...
  // },
  {
    ...
    children: [
      ...
      },
      {
        ...
        children: [
          {
            title: 'JobsTable Starter',
            path: '/account/members/team-starter'
          },
          {
            title: 'Teams',
            path: '/account/members/jobs'
          },
          {
            title: 'Team Info',
      ...
      },
      {
        ...
        children: [
          ...
          },
          {
            title: 'Members & Roles',
            children: [
              { title: 'JobsTable Starter', path: '/account/members/team-starter' },
              { title: 'Teams', path: '/account/members/jobs' },
